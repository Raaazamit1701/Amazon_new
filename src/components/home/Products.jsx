    ...
    <div className='products-container max-w-screen-2xl mx-auto mt-10 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6 xl:gap-10 px-4'>
      {filteredProducts.length > 0 ? (
        filteredProducts.map((item) => (
          <div key={item.id} className='bg-white h-auto border border-gray-200 py-8 z-30 hover:border-transparent shadow-lg hover:shadow-2xl transform hover:scale-105 transition duration-300 relative flex flex-col gap-4 rounded-lg'>
